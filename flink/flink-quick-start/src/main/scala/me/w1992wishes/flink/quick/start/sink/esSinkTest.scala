...
object esSinkTest {
  def main(args: Array[String]): Unit = {
    ...
    val inputStream: DataStream[String] = env.readTextFile("E:\\project\\my_project\\daily-summary\\flink\\flink-quick-start\\src\\main\\resources\\sensor.txt")
    ...
    httpHosts.add(new HttpHost("cdh04", 9200))
