...
import me.w1992wishes.azkaban.response.AzkabanBaseResponse;
        ...
        try {
            while (tryTime <= RETRY) {
                ...
                if (Objects.nonNull(result) && !this.isDefault(method.getName())) {
                    ...
                    if (AzkabanBaseResponse.SUCCESS.equals(field.get(result))) {
            ...
            if (Objects.isNull(result)) {
                ...
                try {
                    ...
                    if (response instanceof AzkabanBaseResponse) {
                        AzkabanBaseResponse baseResponse = (AzkabanBaseResponse) response;
                        baseResponse.setStatus(AzkabanBaseResponse.ERROR);
