...
public class UsersDAO {
    ...
    public me.w1992wishes.hbase.inaction.model.User getUser(String user)
            throws IOException {
        Table users = conn.getTable(TableName.valueOf(TABLE_NAME));
    ...
    public List<me.w1992wishes.hbase.inaction.model.User> getUsers()
            throws IOException {
        Table users = conn.getTable(TableName.valueOf(TABLE_NAME));

        ResultScanner results = users.getScanner(mkScan());
        ArrayList<me.w1992wishes.hbase.inaction.model.User> ret
                = new ArrayList<>();
    ...
    private static class User
            extends me.w1992wishes.hbase.inaction.model.User {
