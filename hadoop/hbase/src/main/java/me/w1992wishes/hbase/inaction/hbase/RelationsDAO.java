...
import me.w1992wishes.hbase.inaction.coprocessors.CountCoprocessor;
...
public class RelationsDAO {
    ...
    public List<me.w1992wishes.hbase.inaction.model.Relation> listFollows(String fromId) throws IOException {
        return listRelations(FOLLOWS_TABLE_NAME, fromId);
    }

    public List<me.w1992wishes.hbase.inaction.model.Relation> listFollowedBy(String fromId) throws IOException {
        return listRelations(FOLLOWED_TABLE_NAME, fromId);
    }

    public List<me.w1992wishes.hbase.inaction.model.Relation> listRelations(byte[] table, String fromId) throws IOException {
        ...
        List<me.w1992wishes.hbase.inaction.model.Relation> ret = new ArrayList<>();
    ...
    private static class Relation extends me.w1992wishes.hbase.inaction.model.Relation {
